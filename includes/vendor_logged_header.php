<nav class="navbar navbar-inverse navbar-fixed-top main-top-nav" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li title="Dashboard">
                    <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/FoodJackal/account/vendor/options.php"><span class="glyphicon glyphicon-dashboard"></span></a>
                </li>
                <li title="Logout">
                    <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/FoodJackal/login/logout.php"><span class="glyphicon  glyphicon glyphicon-log-out"></span></a>
                </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
