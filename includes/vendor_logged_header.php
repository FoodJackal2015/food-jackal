        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <div>
                    ...
                    <!--<a class="navbar-brand" href="#">Food Jackal</a>-->
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="http://cloud.graham-murray.com/FoodJackal">Vendors</a>
                    </li>
                    <li>
                ...
                <li>
                    <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/FoodJackal/logout">Logout</a>
                </li>
                <li>
                    <a href="http://cloud.graham-murray.com/FoodJackal/account/vendor/options.php"><span class="glyphicon glyphicon-cog"></span></a>
                </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
