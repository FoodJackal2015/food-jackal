    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <form class="navbar-form" action="http://<?php echo $_SERVER['SERVER_NAME'];?>/FoodJackal/search/search.php" method="GET" role="search">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Search" name="key" id="srchterm">
                ...
                <li>
                    <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/FoodJackal/signup/customer/">Signup</a>
                </li>
                <li>
                    <a href="http://<?php echo $_SERVER['SERVER_NAME'];?>/FoodJackal/login/">Login</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
