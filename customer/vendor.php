<?php
    ...
    $vendorId = intval($_GET['vid']);
    $conn->connectToDatabase();
    $sql = "SELECT Vendor.*, Product.* FROM Vendor INNER JOIN Product ON Vendor.vendorId=Product.vendorId WHERE Vendor.vendorId='$vendorId'";
